...
Recommended to transform from European reference frame ETR89 (EPSG:4258) 
to Hungarian reference frame HD72/EOV (EPSG:23700).

* hu_bme_hd72corr.tif

### Hungary: ETRS89 --> EOMA 1980 height
...
Recommended to transform from European reference frame ETR89 (EPSG:4937) 
to Hungarian reference frame EOMA 1980 heights (EPSG:5787).
